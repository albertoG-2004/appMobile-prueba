...
fun EditSingleProductScreen(navController: NavHostController, productId: String?) {
    ...
    Surface(
        ...
        Column(
            ...
            Text(
                text = "Modificando chunchesito ID: $productId",
            ...
            if (viewModel.success){
                Text(text = "Chunchesito editado", color = MaterialTheme.colorScheme.primary)
            }
            ...
            Button(
                ...
                modifier = Modifier.fillMaxWidth(),
                shape = RoundedCornerShape(12.dp),
                colors = ButtonDefaults.buttonColors(containerColor = Color(0xFFA020F0), contentColor = Color.Black)
            ) {
                Text(text = "Tomar foto", color = Color.White, fontWeight = FontWeight.Bold, fontSize = 16.sp)
            }
            Spacer(modifier = Modifier.height(8.dp))
            Button(
