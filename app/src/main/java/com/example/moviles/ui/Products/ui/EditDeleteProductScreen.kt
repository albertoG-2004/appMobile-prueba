...
fun EditDeleteProductScreen(navController: NavHostController) {
    ...
    Surface(
        ...
        Column(
            ...
            Text(
                text = "Modificar / Eliminar Chunchesito",
            ...
            if(viewModel.deleteSuccess){
                Text(text = "Chunchesito eliminado!", color = MaterialTheme.colorScheme.primary)
            }
            LazyColumn(
            ...
            Button(
                ...
                colors = ButtonDefaults.buttonColors(containerColor = Color(0xFF800080), contentColor = Color.White), // Botón "Volver" morado con letras blancas
            ) {
                Text(
                    text = "Volver",
                    color = Color.White,
        ...
        Column(
            ...
            Row(
                ...
                Column {
                    ...
                    Text(
                        text = "Precio chunche: ${product.precio}",
                        color = MaterialTheme.colorScheme.onSurface,
            ...
            Row(
                ...
                Button(
                    ...
                    shape = RoundedCornerShape(12.dp),
                    colors = ButtonDefaults.buttonColors(containerColor = Color(0xFFA020F0), contentColor = Color.White), // Botón "Modificar" morado con letras blancas
                ) {
                ...
                Button(
                    ...
                    shape = RoundedCornerShape(12.dp),
                    colors = ButtonDefaults.buttonColors(containerColor = Color(0xFFA020F0), contentColor = Color.White), // Botón "Eliminar" morado con letras blancas
                ) {
